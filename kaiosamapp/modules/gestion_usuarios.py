from modules.funciones_secundarias import reportar_error_a_txt,very,clear_screen,line,linen,print_,es
...
#from modules.catalogo_productos_funciones import mortar_product's,mostrar_tipos_productos
