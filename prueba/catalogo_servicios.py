...
from catalogo_servicios_funciones import id_valido,tipo_servicios,int_precio,mostrar_tipo_servicios
from catalogo_servicios_funciones import int_nuevo,int_regular,int_leal,int_cantidad_total
from catalogo_servicios_funciones import modificar
